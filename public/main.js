...
module.exports = "<div class=\"col-md-8 offset-md-2 text-center mt-5\">\n  <div class=\"card\">\n    <div class=\"card-body\">\n      <h2 class=\"page-header\">\n        Dashboard\n      </h2>\n      <p>Your dashboard</p>\n    </div>\n  </div>\n</div>"
...
module.exports = "<div class=\"col-md-8 offset-md-2\">\n  <h2 class=\"page-header\">Login</h2>\n  <form (submit)=\"onLoginSubmit()\">\n    <div class=\"form-group\">\n      <label>Username</label>\n      <input type=\"text\"\n        [(ngModel)]=\"username\"\n        name=\"username\"\n        class=\"form-control\">\n    </div>\n    <div class=\"form-group\">\n      <label>Password</label>\n      <input type=\"password\"\n        [(ngModel)]=\"password\"\n        name=\"password\"\n        class=\"form-control\">\n    </div>\n    <input type=\"submit\"\n      class=\"btn btn-primary\"\n      value=\"Submit\">\n  </form>\n</div>\n"
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.AuthService.authenticateUser(user)
            ...
            if (data.success) {
                ...
                _this.FlashMessagesService.show('Logged In', { cssClass: 'alert-success', timeout: 4000 });
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.AuthService.registerUser(user)
            ...
            if (data.success) {
                ...
                _this.FlashMessagesService.show('Error', { cssClass: 'alert-danger', timeout: 3000 });
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.handleError = function (error) {
        console.error(error);
        return rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"].throw(error.json() || 'Server error');
    };
...
module.exports = __webpack_require__(/*! /home/carlos/Repositories/mean-stack/mean-frontend/src/main.ts */"./src/main.ts");
